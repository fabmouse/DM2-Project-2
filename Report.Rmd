...
knitr::kable(rTiming, digits = 3, caption = "Changes in Runtime (in seconds) of lmBoot", col.names = c("Samples", "lmBoot", "lmBoot Improved", "lmBoot parallelised"))
```
...
barplot(speedInc, names.arg = c("lmBoot", "lmBoot Improved", 
                                "lmboot Parallelised"), col = "Slateblue", 
        border = "black", main = "", xlab = "Function", ylab = "Time (ms)",
        cex.lab = 0.8, las = 1)
```
