...
From the table below, we could find that when the number of
bootstrapping is low, the boot function performs better than lmBoot\_par
function. With increasing number of bootstrapping, lmBoot\_par function
performs much better than boot function. We could conclude that
vectorization will imrpove function performance especially for
...
\midrule
\endhead
Intercept & 79.298 & 121.093\tabularnewline
Age & -0.429 & -0.005\tabularnewline
Weight & -0.162 & 0.066\tabularnewline
RunTime & -3.298 & -1.870\tabularnewline
RestPulse & -0.174 & 0.101\tabularnewline
RunPulse & -0.557 & -0.083\tabularnewline
